...
# NOTE: Replace this path with the ROOT folder where your 'takeoff', 'right', etc. folders are located.
dataset_path = r"C:\Users\13202\Downloads\brainwave_readings\processed_csv\processed"

# Columns to be dropped
# NOTE: Verify these names exactly match the columns in your CSV files.
columns_to_drop = [
    'Accel Channel 0',
    'Accel Channel 1',
    'Accel Channel 2',
    ...
    for file_name in files:
        if file_name.endswith(".csv"):
            ...
            try:
                ...
                # 2. Clean Column Names (Crucial for successful dropping)
                df.columns = [col.replace('"', '').replace("'", '').replace('\r','').strip() for col in df.columns]

                # 3. Drop the columns
                # This creates a list of columns that exist in the DataFrame AND are in your columns_to_drop list
                ...
                # 4. Save back, overwriting the original file
